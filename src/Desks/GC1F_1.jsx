...
function GC1F_1() {
  ...
  const handleClick = (evt) => {
    ...
    if (
      ...
      deskCoordinates.top < evt.clientY &&
      deskCoordinates.bottom > evt.clientY
    ) {
      handleSelectDesk("GC1F_1");
      setActive(!active);
    }
  };
  React.useEffect(() => {
  ...
  return (
    <g
      ref={myDesk}
      id="prefix__shape869-1042"
      transform="translate(431.859 -236.25)"
    >
      <path
        fill={active ? "lightgreen" : "white"}
        stroke="#000"
        strokeLinecap="round"
