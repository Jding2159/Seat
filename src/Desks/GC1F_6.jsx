...
function GC1F_6() {
	...
	return (
		<g ref={myDesk} id="prefix__shape876-1079" transform="translate(431.719 -423.075)">
        ...
        <text x={18.71} y={772.2} className="prefix__st20">
          {"John"}
          <tspan x={20.05} dy="1.2em" className="prefix__st25">
            {"Doe"}
          </tspan>
        </text>
      </g>
